...
src - source code repo
	...
	training - code to train different models
		ML_Project_Train.ipynb - code to train and evaluate on different algorithms and configurations
================================================================================================================
...
Training:
	Open "ML_Project_Train.ipynb" in jupyer notebook
	...
	For faster training, 10% training sample can be used, uncomment the relevant part. 
		Make sure you run this cell only once while comparing different algorithms and configurations. 
